...
const { showGoods, showAccountGoods, showGood, addGood, updateBatch, showCategory, editGood } = require("../controllers/Goods");
...
goodsRouter.put("/:goodId/edit", auth, editGood);
